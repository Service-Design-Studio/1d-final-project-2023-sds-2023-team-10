...
Then("the user will land on 'Take short questionaire' page", async () => {
  ...
  const chatTitle = await page.$eval(".app_Start__ubJe1 > h1", (elem) =>
    elem.textContent.trim()
  );
  if (chatTitle !== expectedQuestionaireTitle.trim()) {
    throw new Error(
      `Expected questionaire title "${expectedQuestionaireTitle}", but got "${chatTitle}" instead`
    );
  }
});
...
Then("clicks on 'Yes, my doctor confirmed it'", async () => {
  await page.waitForSelector(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(2)"
  );
  await page.click(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(2)"
  );
...
Then("user selects 'I'm worried what others may think of me'", async () => {
  await page.waitForSelector(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(4)"
  );
  await page.click(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(4)"
  );
...
Then("selects 'I lack resources to keep the baby'", async () => {
  await page.waitForSelector(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(5)"
  );
  await page.click(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(5)"
  );
...
Then("user clicks 'Submit'", async () => {
  await page.waitForSelector(
    "#__next > div > div > div > div:nth-child(2) > div > button"
  );
  await page.click(
    "#__next > div > div > div > div:nth-child(2) > div > button"
  );
...
Then("user clicks 'I'm alone'", async () => {
  await page.waitForSelector(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(1)"
  );
  await page.click(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(1)"
  );
...
Then("user clicks 'I'm a divorcee\\/widow. What are my options?'", async () => {
  await page.waitForSelector(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(3)"
  );
  await page.click(
    "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(3)"
  );
...
Then(
  "user clicks 'What to expect during pregnancy, labour and delivery'",
  async () => {
    await page.waitForSelector(
      "#__next > div > div > div > div:nth-child(2) > div > div > div:nth-child(2)"
    );
...
Then("lands on 'Let us know more about you!' page", async () => {
  ...
  const formTitle = await page.$eval(".app_submitTitle__V3amC", (elem) =>
    elem.textContent.trim()
  );
  if (formTitle !== expectedFormpage.trim()) {
    throw new Error(
      `Expected questionaire title "${expectedFormpage}", but got "${formTitle}" instead`
    );
  }
});
...
Then("User selects 'First Name' Text box", async () => {
  await page.waitForSelector(
    "#__next > div > div > div > form > div > div:nth-child(1) > div > div:nth-child(1)"
  );
  await page.click(
    "#__next > div > div > div > form > div > div:nth-child(1) > div > div:nth-child(1)"
  );
...
Then("clicks on 'Next'", async () => {
  await page.waitForSelector(
    "#__next > div > div > div > form > div > div.app_buttonSubmitContainer__9CQ_6 > button.app_nextQButton__lp55v"
  );
  await page.click(
    "#__next > div > div > div > form > div > div.app_buttonSubmitContainer__9CQ_6 > button.app_nextQButton__lp55v"
  );
