...
// Given("Alice just found out her pregnancy test is negative", async () => {
...
//   await page.waitForSelector("#__next > div > div > div.py-5 > div > ul > li:nth-child(4)");
//   await page.click("#__next > div > div > div.py-5 > div > ul > li:nth-child(4)");

//   // Wait for the text box to appear on the page
//   await page.waitForSelector(
//     "#__next > div > div > div.py-5 > div > div > div > div.css-sdxdhq > input"
//   );
...
// Then('the counsellor will receives the message', async function () {
...
// When('the counsellor will see from the sentiment analysis data that she is in a good mood', async function () {
//   await page.waitForSelector("#__next > section > main > div > div:nth-child(1) > div > div > div > div > div > li:nth-child(30)");
//   await page.click("#__next > section > main > div > div:nth-child(1) > div > div > div > div > div > li:nth-child(30)");
// });

// Then('the counsellor will send her a reply', async function () {
//   await page.waitForSelector(
